	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800229:	0f be 80 e8 0f 80 00 	movsbl 0x800fe8(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800376:	ff 24 8d a0 10 80 00 	jmp    *0x8010a0(,%ecx,4)
  ...
  800436:	c7 44 24 08 09 10 80 	movl   $0x801009,0x8(%esp)
  80043d:	00 
  ...
  80046a:	75 05                	jne    800471 <vprintfmt+0x185>
				p = "(null)";
  80046c:	be f9 0f 80 00       	mov    $0x800ff9,%esi
			if (width > 0 && padc != '-')
